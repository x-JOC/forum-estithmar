    ...
    <header class="relative bg-primary-500 text-white overflow-hidden pb-12 pt-6 rounded-b-[40px] shadow-lg">
        ...
        <div class="relative z-10 max-w-md mx-auto px-5 flex flex-col items-center text-center">
            ...
            <p class="text-[15px] leading-relaxed text-white mb-8 px-2">
                تُشارك استثمار المستقبل في ملتقى الأوقاف <span class="text-secondary-500 font-bold">كراعي ماسي</span> بصحبة نخبة من مستشاريها متواجدون على مدار اليومين في الواجهة الرئيسية للحدث.
            </p>
    ...
    <main class="px-5 py-12 flex flex-col items-center max-w-md mx-auto z-20 relative">
        ...
        <div class="w-full mb-12">
            ...
            <div id="formContainer" class="bg-white rounded-[24px] shadow-xl shadow-primary-500/5 p-6 md:p-8 w-full border border-accent-500/20 relative overflow-hidden h-0 opacity-0 transition-all duration-500">
                ...
                <form class="space-y-4 relative z-10" id="bookingForm" data-page-type="استشارة-ملتقى" onsubmit="handleFormSubmit(event)">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-primary-500 mb-1">الخدمة <span class="text-accent-500 font-normal text-xs">(اختياري)</span></label>
                        <select name="service" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-success-500/50 focus:border-success-500 outline-none transition-all">
                            ...
                            <option value="تأسيس الأوقاف">تأسيس الأوقاف</option>
                            <option value="استشارات استثمارية">استشارات استثمارية</option>
                            <option value="حلول الاستدامة">حلول الاستدامة</option>
                            <option value="مراجعة ودراسة الوصايا">مراجعة ودراسة الوصايا</option>
                        </select>
                    </div>
        ...
        <div class="mb-8 w-full text-center">
            <h3 class="text-xl font-bold text-primary-500 mb-6 inline-block relative">
                تعرّف على مستشاري استثمار المستقبل
                <span class="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-secondary-500 rounded-full"></span>
            </h3>
            
            <div class="grid grid-cols-2 gap-4 mt-8">
                <!-- Consultant 1 -->
                <div class="bg-white rounded-2xl p-4 shadow-sm border border-accent-500/20 flex flex-col items-center">
                    <div class="w-16 h-16 rounded-full bg-slate-100 mb-3 border-2 border-tertiary-500/30 flex items-center justify-center overflow-hidden">
                        <svg class="w-8 h-8 text-accent-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </div>
                    <h4 class="text-sm font-bold text-primary-500 mb-1 text-center">أحمد عبدالله</h4>
                    <p class="text-xs text-success-500 font-bold text-center">خبير أوقاف</p>
                </div>
                <!-- Consultant 2 -->
                <div class="bg-white rounded-2xl p-4 shadow-sm border border-accent-500/20 flex flex-col items-center">
                    <div class="w-16 h-16 rounded-full bg-slate-100 mb-3 border-2 border-tertiary-500/30 flex items-center justify-center overflow-hidden">
                    ...
                    <h4 class="text-sm font-bold text-primary-500 mb-1 text-center">عبدالرحمن صالح</h4>
                    <p class="text-xs text-success-500 font-bold text-center">مستشار مالي</p>
                </div>
            </div>
        </div>
    </main>
    ...
    <footer class="bg-primary-500 text-white pt-12 pb-10 px-6 text-center rounded-t-[40px] mt-4 relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-md mx-auto">
            ...
            <div class="flex flex-wrap justify-center items-center gap-4 mb-8">
                <!-- WhatsApp -->
                <a href="https://wa.me/966XXXXXXXXX" target="_blank" class="w-12 h-12 rounded-full bg-success-500 text-white flex items-center justify-center hover:bg-white hover:text-success-500 transition-all transform hover:scale-110 shadow-lg">
                ...
                <!-- Email -->
                <a href="mailto:info@estithmar.example.com" class="w-12 h-12 rounded-full bg-white/10 text-white flex items-center justify-center hover:bg-tertiary-500 transition-all transform hover:scale-110">
                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                </a>
                
                <!-- X (Twitter) -->
                <a href="#" class="w-12 h-12 rounded-full bg-white/10 text-white flex items-center justify-center hover:bg-tertiary-500 transition-all transform hover:scale-110">
            ...
            <p class="text-[13px] text-accent-500 font-medium mt-6">© 2026 شركة استثمار المستقبل. جميع الحقوق محفوظة.</p>
        </div>
    </footer>
